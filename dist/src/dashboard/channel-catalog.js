 ...
 */
// Shared SVG path-d strings — reused across entries to keep the catalog compact.
const ICON_USER = "M20 21v-2a4 4 0 00-4-4H8a4 4 0 00-4 4v2 M12 11a4 4 0 100-8 4 4 0 000 8z";
const ICON_BRANCH = "M6 3v12 M18 9a3 3 0 100-6 3 3 0 000 6z M6 21a3 3 0 100-6 3 3 0 000 6z M18 9a9 9 0 01-9 9";
const ICON_CLOCK = "M12 2a10 10 0 100 20 10 10 0 000-20z M12 6v6l4 2";
const ICON_PULSE = "M22 12h-4l-3 9L9 3l-3 9H2";
const ICON_LINK = "M10 13a5 5 0 007.54.54l3-3a5 5 0 00-7.07-7.07l-1.72 1.71 M14 11a5 5 0 00-7.54-.54l-3 3a5 5 0 007.07 7.07l1.71-1.71";
const ICON_HELP = "M12 2a10 10 0 100 20 10 10 0 000-20z M9.09 9a3 3 0 015.83 1c0 2-3 3-3 3 M12 17h.01";
...
const CATALOG = {
    ...
    // ── messaging providers (from OpenClaw + common third-party) ─────
    telegram: {
        id: "telegram",
        kind: "messaging",
        label: "Telegram",
...
/**
 * Title-case a channel id for the synthetic fallback label.
 * "foo-bar" / "foo_bar" → "Foo Bar". Empty string → "".
 */
...
//# sourceMappingURL=channel-catalog.js.map