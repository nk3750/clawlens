 ...
 */
export function extractUrlsForGuardrail(toolName, params) {
    switch (toolName) {
        case "web_fetch":
        case "fetch_url":
        case "browser": {
 ...
 */
export function extractPathsForGuardrail(toolName, params) {
    switch (toolName) {
        case "read":
        case "write":
        case "edit": {
 ...
 */
export function extractCommandForGuardrail(toolName, params) {
    if (toolName !== "exec")
        return null;
