 ...
 */
export function extractAllPatchPaths(patch: string): string[] {
  if (!patch) return [];
...
export function formatTargetSummary(target: Target): string {
  switch (target.kind) {
    case "path-glob":
