...
/** Critical threshold — score ≥75 is the "crit" tier. Used by the tape-tier
 *  classifier in FleetRiskTile.tsx; the chart's tier classification goes
 *  through getEffectiveTier-mirrored bucketCountsByTier instead. */
